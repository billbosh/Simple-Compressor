...
SimpleCompressorAudioProcessor::SimpleCompressorAudioProcessor()
    ...
    parameters(*this, nullptr, "simplecomp", {
        ...
        std::make_unique<AudioParameterFloat>(ratioParamID, "Ratio", NormalisableRange<float> {1.f, 20.f, 0.01f, 0.37552f}, 1.f),
        std::make_unique<AudioParameterFloat>(attackParamID, "Attack", NormalisableRange<float> {0.01f, 1000.f, 0.01f, 0.30101f}, 1.f),
